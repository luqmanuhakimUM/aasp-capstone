...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="material-sidebar hidden flex-col items-center justify-between px-12 py-12 text-sidebar-fg lg:flex">
        ...
        <div className="flex items-start gap-2 border-t border-sidebar-accent pt-6 text-caption text-sidebar-muted">
